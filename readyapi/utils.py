...
def create_model_field(
    ...
    if annotation_is_pydantic_v1(type_):
        raise PydanticV1NotSupportedError(
            "pydantic.v1 models are no longer supported by ReadyAPI."
    ...
    try:
        ...
        raise readyapi.exceptions.ReadyAPIError(
...
def generate_operation_id_for_path(
    *, name: str, path: str, method: str
    ...
    warnings.warn(
        message="readyapi.utils.generate_operation_id_for_path() was deprecated, "
