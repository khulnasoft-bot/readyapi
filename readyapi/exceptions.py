    ...
    def __init__(
        ...
        status_code: Annotated[
            ...
            Doc(
                ...
                Read more about it in the
                [ReadyAPI docs for Handling Errors](https://readyapi.khulnasoft.com/tutorial/handling-errors/#use-httpexception)
                """
            ),
        ],
        detail: Annotated[
        ...
        headers: Annotated[
            ...
            Doc(
                ...
                Read more about it in the
                [ReadyAPI docs for Handling Errors](https://readyapi.khulnasoft.com/tutorial/handling-errors/#add-custom-headers)
...
class ReadyAPIError(RuntimeError):
    """
    A generic, ReadyAPI-specific error.
    """


class DependencyScopeError(ReadyAPIError):
    """
...
class PydanticV1NotSupportedError(ReadyAPIError):
    """
    A pydantic.v1 model is used, which is no longer supported.
    """


class ReadyAPIDeprecationWarning(UserWarning):
    """
