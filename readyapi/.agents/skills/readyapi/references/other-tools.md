...
If Ruff is available, use it to lint and format the code. Consider enabling the ReadyAPI rules.
...
When working with SQL databases, prefer using SQLDev as it is integrated with Pydantic and will allow declaring data validation with the same models.
