...
from readyapi.datastructures import DefaultPlaceholder
...
from readyapi.openapi.constants import METHODS_WITH_BODY, REF_PREFIX
from readyapi.openapi.models import OpenAPI
from readyapi.params import Body, ParamTypes
from readyapi.responses import Response
from readyapi.sse import _SSE_EVENT_SCHEMA
from readyapi.types import ModelNameMap
...
def generate_operation_id(
    *, route: routing.APIRoute, method: str
    ...
    warnings.warn(
        message="readyapi.openapi.utils.generate_operation_id() was deprecated, "
