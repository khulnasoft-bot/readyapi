...
from readyapi.openapi.models import OAuth2 as OAuth2Model
from readyapi.openapi.models import OAuthFlows as OAuthFlowsModel
from readyapi.param_functions import Form
...
class OAuth2(SecurityBase):
    ...
    def make_not_authenticated_error(self) -> HTTPException:
        ...
        ones in ReadyAPI (based on bearer tokens), you might want to override this.
