    ...
    *,
    ...
    title: Annotated[
        ...
        Doc(
            ...
            [ReadyAPI docs for Path Parameters and Numeric Validations](https://readyapi.khulnasoft.com/tutorial/path-params-numeric-validations/#declare-metadata)
            """
        ),
    ] = None,
    ...
    gt: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs about Path parameters numeric validations](https://readyapi.khulnasoft.com/tutorial/path-params-numeric-validations/#number-validations-greater-than-and-less-than-or-equal)
            """
        ),
    ] = None,
    ge: Annotated[
    ...
    examples: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs for Declare Request Example Data](https://readyapi.khulnasoft.com/tutorial/schema-extra-example/)
            """
        ),
    ] = None,
    example: Annotated[
...
def Query(  # noqa: N802
    default: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs about Query parameters](https://readyapi.khulnasoft.com/tutorial/query-params-str-validations/#alternative-old-query-as-the-default-value)
            """
        ),
    ] = Undefined,
    *,
    ...
    alias: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs about Query parameters](https://readyapi.khulnasoft.com/tutorial/query-params-str-validations/#alias-parameters)
            """
        ),
    ] = None,
    alias_priority: Annotated[
    ...
    title: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs about Query parameters](https://readyapi.khulnasoft.com/tutorial/query-params-str-validations/#declare-more-metadata)
            """
        ),
    ] = None,
    description: Annotated[
    ...
    min_length: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs about Query parameters](https://readyapi.khulnasoft.com/tutorial/query-params-str-validations/)
            """
        ),
    ] = None,
    max_length: Annotated[
    ...
    pattern: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs about Query parameters](https://readyapi.khulnasoft.com/tutorial/query-params-str-validations/#add-regular-expressions
            """
        ),
    ] = None,
    regex: Annotated[
    ...
    deprecated: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs about Query parameters](https://readyapi.khulnasoft.com/tutorial/query-params-str-validations/#deprecating-parameters)
            """
        ),
    ] = None,
    include_in_schema: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs about Query parameters](https://readyapi.khulnasoft.com/tutorial/query-params-str-validations/#exclude-parameters-from-openapi
            """
        ),
    ] = True,
    json_schema_extra: Annotated[
    ...
    *,
    use_cache: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs about sub-dependencies](https://readyapi.khulnasoft.com/tutorial/dependencies/sub-dependencies/#using-the-same-dependency-multiple-times)
            """
        ),
    ] = True,
    scope: Annotated[
        ...
        Doc(
            ...
            * `"request"`: start the dependency before the *path operation function*
            ...
            Read more about it in the
            [ReadyAPI docs for ReadyAPI Dependencies with yield](https://readyapi.khulnasoft.com/tutorial/dependencies/dependencies-with-yield/#early-exit-and-scope)
            """
        ),
    ] = None,
) -> Any:
    ...
    *,
    scopes: Annotated[
        ...
        Doc(
            ...
            Read more about it in the
            [ReadyAPI docs about OAuth2 scopes](https://readyapi.khulnasoft.com/advanced/security/oauth2-scopes/)
            """
        ),
    ] = None,
    use_cache: Annotated[
