...
This is a link with attributes: [**ReadyAPI** Project Generators](project-generation.md){.internal-link target=_blank}

This is a link to the main ReadyAPI site: [ReadyAPI](https://readyapi.khulnasoft.com) - tool should add language code to the URL.

This is a link to one of the pages on ReadyAPI site: [How to](https://readyapi.khulnasoft.com/how-to/) - tool should add language code to the URL.

Link to test wrong attribute: [**ReadyAPI** Project Generators](project-generation.md){.internal-link} - tool should fix the attribute.
...
This is an <a href="https://readyapi.khulnasoft.com">link to the main ReadyAPI site</a> - tool should add language code to the URL.

This is an <a href="https://readyapi.khulnasoft.com/how-to/">link to one of the pages on ReadyAPI site</a> - tool should add language code to the URL.

Link to test wrong attribute: <a href="project-generation.md" class="internal-link">**ReadyAPI** Project Generators</a> - tool should fix the attribute.
...
# Header (with HTML link to <a href="https://khulnasoft.com">khulnasoft.com</a>) { #header-with-html-link-to-khulnasoft-com }
