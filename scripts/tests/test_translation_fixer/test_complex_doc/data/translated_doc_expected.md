...
Это ссылка на основной сайт ReadyAPI: [ReadyAPI](https://readyapi.khulnasoft.com/lang) — инструмент должен добавить код языка в URL.

Это ссылка на одну из страниц на сайте ReadyAPI: [How to](https://readyapi.khulnasoft.com/lang/how-to/) — инструмент должен добавить код языка в URL.

Ссылка для тестирования неправильного атрибута: [**ReadyAPI** генераторы проектов](project-generation.md){.internal-link} - инструмент должен исправить атрибут.
...
Это <a href="https://readyapi.khulnasoft.com/lang">ссылка на основной сайт ReadyAPI</a> — инструмент должен добавить код языка в URL.

Это <a href="https://readyapi.khulnasoft.com/lang/how-to/">ссылка на одну из страниц на сайте ReadyAPI</a> — инструмент должен добавить код языка в URL.

Ссылка для тестирования неправильного атрибута: <a href="project-generation.md" class="internal-link">**ReadyAPI** генераторы проектов</a> - инструмент должен исправить атрибут.
...
# Заголовок (с HTML ссылкой на <a href="https://khulnasoft.com">khulnasoft.com</a>) { #header-with-html-link-to-khulnasoft-com }
