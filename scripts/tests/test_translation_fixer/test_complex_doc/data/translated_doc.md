...
{* ../../examples/bigger_applications/app_an_py310/wrong.py hl[3] title["app/internal/admin.py"] *}

{* ../../examples/dependencies/tutorial013_an_py310.py ln[1:30] hl[1:10] *}
...
Это ссылка с атрибутами: [**ReadyAPI** генераторы проектов](project-generation.md){.internal-link target=_blank}

Это ссылка на основной сайт ReadyAPI: [ReadyAPI](https://readyapi.khulnasoft.com) — инструмент должен добавить код языка в URL.

Это ссылка на одну из страниц на сайте ReadyAPI: [How to](https://readyapi.khulnasoft.com/how-to) — инструмент должен добавить код языка в URL.

Ссылка для тестирования неправильного атрибута: [**ReadyAPI** генераторы проектов](project-generation.md){.external-link} - инструмент должен исправить атрибут.
...
* [ReadyAPI Logo](https://readyapi.khulnasoft.com/img/readyapi-logo.png)
* [ReadyAPI CSS](https://readyapi.khulnasoft.com/css/readyapi.css)
* [ReadyAPI JS](https://readyapi.khulnasoft.com/js/readyapi.js)
...
Это <a href="https://readyapi.khulnasoft.com">ссылка на основной сайт ReadyAPI</a> — инструмент должен добавить код языка в URL.

Это <a href="https://readyapi.khulnasoft.com/how-to/">ссылка на одну из страниц на сайте ReadyAPI</a> — инструмент должен добавить код языка в URL.

Ссылка для тестирования неправильного атрибута: <a href="project-generation.md" class="external-link">**ReadyAPI** генераторы проектов</a> - инструмент должен исправить атрибут.

### HTML ссылки на статические ресурсы { #html-links-to-static-assets }

Это ссылки на статические ресурсы:

* <a href="https://readyapi.khulnasoft.com/img/readyapi-logo.png">ReadyAPI Logo</a>
* <a href="https://readyapi.khulnasoft.com/css/readyapi.css">ReadyAPI CSS</a>
* <a href="https://readyapi.khulnasoft.com/js/readyapi.js">ReadyAPI JS</a>

Инструмент НЕ должен добавлять код языка в их URL.

# Заголовок (с HTML ссылкой на <a href="https://khulnasoft.com">khulnasoft.com</a>) { #header-5 }
