...
<span style="background-color:#009485"><font color="#D3D7CF"> ReadyAPI </font></span>  Starting server
...
- For absolute URLs which DO NOT start EXACTLY with https://readyapi.khulnasoft.com, only translate the link text and leave the URL unchanged.
...
- For absolute URLs which DO start EXACTLY with https://readyapi.khulnasoft.com, only translate the link text and change the URL by adding the language code (https://readyapi.khulnasoft.com/{language_code}[rest part of the url]).
...
```
<a href="https://readyapi.khulnasoft.com/tutorial/path-params/#documentation" class="external-link" target="_blank">Documentation</a>
```

Result (Spanish):

```
<a href="https://readyapi.khulnasoft.com/es/tutorial/path-params/#documentation" class="external-link" target="_blank">Documentación</a>
```
...
```
<a href="https://readyapi.khulnasoft.com/img/something.jpg" class="external-link" target="_blank">Something</a>
```

Result (Spanish):

```
<a href="https://readyapi.khulnasoft.com/img/something.jpg" class="external-link" target="_blank">Algo</a>
```
...
```
[Pull Requests erzeugen](help-readyapi.md#create-a-pull-request){.internal-link target=_blank}
```
