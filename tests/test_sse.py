...
import pytest
import readyapi.routing
from pydantic import BaseModel
from readyapi import APIRouter, ReadyAPI
from readyapi.responses import EventSourceResponse
from readyapi.sse import ServerSentEvent
...
def test_keepalive_ping_async(monkeypatch: pytest.MonkeyPatch):
    monkeypatch.setattr(readyapi.routing, "_PING_INTERVAL", 0.05)
