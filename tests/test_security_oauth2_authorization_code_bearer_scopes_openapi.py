# Ref: https://github.com/khulnasoft/readyapi/issues/14454

from typing import Annotated

from inline_snapshot import snapshot
from readyapi import APIRouter, Depends, ReadyAPI, Security
...
app = ReadyAPI(dependencies=[Depends(get_token)])
