...
These tests verify that special ReadyAPI types can be used with Depends() annotations
and that the dependency injection system properly handles them.
"""

from typing import Annotated

from readyapi import BackgroundTasks, Depends, ReadyAPI, Request, Response
